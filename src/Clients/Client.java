...
public class Client {
    ...
    public Client(String name, String password) {// get started.
        this.clientInformation = new ClientInformation(name, password, 1);
        clientInformation.setClient(this);
        initClientList();
    }

    public Client(ClientInformation clientInformation) {// suggest use this.
    ...
    public Object getObject() throws GetMessageException {
        ...
        if (o instanceof Message) {
            ...
            if(message.getType().equals("server")){
                ...
                String temp_text = message.getTag() + message.getSender_clientInformation().getName() + message.getText();
