...
//            Label inputt = new Label("雪豹闭嘴");
//            inputt.setStyle("-fx-text-fill: white;" + "-fx-background-radius: 10px;" + "-fx-background-color: gray;"
//                    + "-fx-border-width: 7px;" + "-fx-border-radius: 5px;" + "-fx-border-color: gray;");
//            StackPane spt = new StackPane();
//            spt.getChildren().add(inputt);
//            spt.setAlignment(Pos.TOP_LEFT);
//            chatArea.getChildren().add(spt);
    ...
    public static void printMessage(String text) {
        ...
        Platform.runLater(() -> {
            ...
            mainSceneInstance.chatAreaToBottom = true;
        });
